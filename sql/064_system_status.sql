...
('Comunidade', 'DISCORD BOT, Funcionamento em geral, Blog ETC', 3),
('Tarefas agendadas', 'Tarefas agendadas pelos clientes como pagamentos, Datas, Mudanças de plano, Downgrades etc.', 4),
('DISCORD BOT', 'Sistema do DISCORD BOT', 5),
('Notificações', 'Notificações de Segurança, Notificações de Atualizações, Logs ETC.', 6),
('Painel de controle', 'Dashboard flwdesk.com/servers e * dentro desse mesmo esquema do dashboard', 7),
('DNS', 'DNS do sistema', 8),
('CDN', 'CDN, imagens do sistema, carregamento ETC', 9),
('Registro de domínio', 'Registro de domínios, clientes, subdomínios dos transcripts dos clientes, nossos domínios e subdomínios oficiais tbm', 10),
('Rede', 'Redes, Otimizações, Ethernet do sistema, Velocidade de carregamento, Velocidade do banco de dados', 11),
('Firewall DNS', 'Firewall, segurança etc.', 12),
('Geolocalização de IP', 'Geolocalização, Puxar IP, Localização de tudo etc', 13),
('Otimização', 'Otimizações do sistema, Otimizações de rede, Otimizações de imagem, Otimizações do carregamento, Otimizações de DB', 14),
('Registros de auditoria', 'Logs, Históricos de pagamento, Históricos da conta, Histórico de mensagens com IA, Histórico de transcripts, paginas de transcripts entre outros.', 15),
('Pagamentos e transações', 'Pagamentos, Criações de pagamentos, Validações, Recusados, Pendentes, Pagamentos dos sistemas dos clientes, Recorrências, PIX, CARTAO, *, *. Entre outros', 16),
('Cache', 'Cache do sistema de salvamento, Cache de imagens, Cache interno, Cache geral', 17),
('Velocidade do sistema', 'Velocidade de carregamento do sistema, Velocidade de resposta, Velocidade da IA, Velocidade de Renderização, Velocidade de abertura e fechamento, Velocidade de criação de pagamentos, Logs, Registros e funcionamentos', 18),
('Certificado SSL', 'Certificado SSL do sistema Oficial, Subdomínios, Paginas de clientes e Subdomínios Clientes', 19),
('Armazenamento DB', 'Armazenamento de informações, Armazenamento local, Armazenamento temporário, Armazenamento DB, Armazenamento de cache etc', 20),
('Analises da Web', 'Analise de comportamento, Analise de logs, velocidades, renderização, funções, padrões, bots, ataques, etc', 21)
